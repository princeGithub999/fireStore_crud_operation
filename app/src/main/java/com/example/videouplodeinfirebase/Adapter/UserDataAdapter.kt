package com.example.videouplodeinfirebase.Adapter
...
class UserDataAdapter(private val context: Context, private var userList: List<UserDataModle>) :
        ...
        holder.deleteButton.setOnClickListener {
            FirebaseFirestore.getInstance()
                ...
                .addOnSuccessListener {
                    ...
                    FirebaseFirestore.getInstance().collection("youTub").get()
